var BuildingPhraseList = [
	...
	["Alder","Alder Residence Hall","Alder Building","Canyon Complex","Dorms"],														// Alder Hall
	["Art A","Art A Building","ArtA"],																								// Art A Building
	...
	["Cedar","Cedar Residence Hall","Cedar Building","Canyon Complex","Dorms"],														// Cedar Hall
	["Ceramics Lab", "CERAM"],																								// Ceramics Lab
	["Child Development Lab", "Swetman Child Development Lab","CDL","House 31"], 																	// Child Development Lab
	["Chinquapin", "Chinquapin Residence Hall","Chinquapin Building","Canyon Complex","Dorms"],											// Chinquapin Hall
	...
	["College Creek Field Gate", "Soccer Field"],																	// College Creek Locker Rooms
	...
	["Community Center", "Community Services", "Great Hall"],																						// Community Center
	...
	["Fish Hatchery","Wildlife Facilities","FSH"],																		// Fisheries Hatchery
	["Forestry","FR","FOR","FR203"],                	                                							// Forestry
	...
	["Jenkins Hall", "JH"],																								// Jenkins House
	["Jensen House", "JENH"],																								// Jensen House
	["Jolly Giant Commons", "Mail Rooms", "The J", "Dining", "Food", "JGC"],														// Jolly Giant Commons
	["Juniper Residence Hall", "Creekview Complex", "Dorms"],																// Juniper Hall - Creekview
	["Kinesiology and Athletics","KA", "Basketball","Pool","Locker Room","Lumberjack arena"],									// Kinesiology and Athletics
	...
	["Marketing and Communication", "MarCom", "Marketing and Communications"],																				// MarCom
	...
	["Parking Kiosk", "Parking Services"],																								// Parking Services Kiosk
	...
	["Science A","Physics","ScienceA364","Chemistry","CHEM","PHYX","BIOL","Biology", "BIO", "A"],                  			// Science A
	["Science B", "Science B", "SciB", "SB", "B"],							  												// Science B
	["Science C", "Science C", "SciC", "SC", "C"],							  												// Science C
	["Science D", "Science D", "SciD", "SD", "D"],							  												// Science D		
	["Sculpture Lab", "SCLPT"],																								// Sculpture Lab
	["Siemens Hall", "SH","English Department","ENGL"],																		// Siemens Hall
	["Community Center", "College Creek Market Place","South Campus Market Place","Food","The Market","Marketplace", "Dining", "Food"],         // South Campus Market Place
	["Student Business Services", "Cashiers", "Financial Aid", "Registrar", "Administration", "SBS"],								// Student Business Services
	["Student Recreation Center", "Gym", "indoor soccer field", "Rock climbing wall","Fieldhouse", "SRC"],							// Student Recreation Center
	...
	["Trinity Annex", "ANEX"],																								// Trininty Anex
	...
	["Wildlife and Fisheries", "WD", "WDFS", "FS", "WDFS166","Game Pens","Fish Hatchery"],							// Wildlife and Fisheries
