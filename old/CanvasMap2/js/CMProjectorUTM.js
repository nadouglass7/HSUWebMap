...
*
*/
CMProjectorUTM.prototype.GetBounds=function()
{
	var LongOrigin=(this.UTMZone - 1)*6 - 180 + 3;  //+3 puts origin in middle of zone
	
	var Bounds={
		East:-80, // at below 75 (50 from center of zone) the reverse transform starts to fail.
		West:-160, // center is 120
		North:90,
		South:-90
	};
	return(Bounds);
