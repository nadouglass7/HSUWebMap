...
CMMainContainer.ELEMENT_DEFS=[
	...
	["CM_AttributePanel",			"div",			"CM_TimeEditPanel"], // 19
...
//		MapContainer.appendChild(HoriziontalTabContainerElement);
		...
		{
			var TheTimeEditor=new CMPanelTime(this);
			TheTimeEditor.SetElement(TimeEditorPanelElement);
			...
			TheTimeEditor.SetSettingsPanel(TheSettingsPanel); // connect the settings panel to the time editor panel
