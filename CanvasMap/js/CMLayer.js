...
* @protected, @override
*/
CMLayer.prototype.SettingsChanged=function()
{
...
/**
* Gets the feature settings for one feature
* @public
* @param FeatureIndex - Index to the feature
* @param TheDefault - default settings
* @returns - the desired setting or TheDefault if none
*/
...
CMLayer.prototype.GetIcon=function()
{
	...
	if (TheIcon==null)
	{
		...
		if (CMUtilities.IsDefined(TheType)==false) // does not have a mark
		{
		...
		else // has a mark (circle, triangle, etc.)
		{
			...
			TheView.Setup(TheIcon,TheCanvas);
