...
{
	var TheGeoJSONObject=JSON.stringify(this.TheData);
	
	URL=URL+encodeURI("?Data="+TheGeoJSONObject);
...
CMDatasetGeoJSON.prototype.CMDataset_GetIcon=CMDataset.prototype.GetIcon;

CMDatasetGeoJSON.prototype.GetIcon=function(TheLayer,Default)
{
	...
	if ((this.TheData!=null)) //(this.GetVisible())&&
	{
		...
		if (TheFeatures.length>0)
		{
			var TheGeometry=TheFeatures[0].geometry;
			
			if ((TheGeometry.type=="LineString")||(TheGeometry.type=="MultiLineString"))
			{
				TheIcon=document.createElement('div');
				TheIcon.className="CM_LayerListIconClass";
				TheIcon.TheLayer=this;
				TheIcon.style.backgroundColor="rgba(0,0,0,0)";
				TheIcon.style.borderColor="rgba(0,0,0,0)";
				
				var TheCanvas=document.createElement('CANVAS');
				TheCanvas.width=16;
				TheCanvas.height=16;
				TheIcon.appendChild(TheCanvas);
